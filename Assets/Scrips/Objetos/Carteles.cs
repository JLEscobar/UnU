...
using UnityEngine;
    ...
    public class Carteles : MonoBehaviour
    {
        ...
        void Update()
        {
            informacionHabilitada = Physics2D.OverlapCircle(this.transform.position, .5f, personaje);
            ...
            mostrarInformacionHabilitada = Physics2D.OverlapCircle(this.transform.position, .5f, personaje);
